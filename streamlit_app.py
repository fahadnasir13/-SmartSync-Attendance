...
# Apply minimalistic styling with essential elements only
st.markdown(
    """
    <style>
        ...
        /* Global styles with a tech-inspired background */
        body {
            background: #1c2526; /* Deep charcoal gray for a sleek tech feel */
        ...
        h1 span {
            color: #00c4cc; /* Vibrant teal accent */
        }

        /* Subtitle styling */
        .subtitle {
            color: #a0aec0; /* Soft gray for subtitles */
            font-size: 1.1rem;
            text-align: center;
            margin-bottom: 2rem;
            font-weight: 400;
        ...
        .stTable th, .stTable td {
            ...
            text-align: center;
            font-size: 0.95rem;
            border-bottom: 1px solid #37464b;
        }
        .stTable th {
            background: #2e3a3d;
            font-weight: 600;
        ...
        .card {
            background: #2e3a3d; /* Slate gray for cards */
            border-radius: 10px;
            padding: 20px;
            margin-bottom: 1.5rem;
            border: 1px solid #37464b;
